...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div
      onClick={onClose}
      className="fixed z-50 flex justify-center items-center bg-neutral-800/70 inset-0 outline-none focus:outline-none overflow-x-hidden overflow-y-auto p-10"
    >
      {/* <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 h-full lg:h-auto md:h-auto mx-auto my-6"> */}
      <div className="relative w-full md:w-5/6 lg:w-4/6 xl:w-3/5 h-full lg:h-auto md:h-auto mx-auto my-6">
        {/* CONTENT */}
        <div
        ...
        >
          ...
          <div
            ...
            className="relative bg-white w-full h-full lg:h-auto md:h-auto flex flex-col rounded-lg shadow-lg border-0 outline-none focus:outline-none translate"
          >
            {/* HEADER */}
            <div className="relative flex justify-center items-center rounded-t p-6 border-b-[1px]">
              <button
