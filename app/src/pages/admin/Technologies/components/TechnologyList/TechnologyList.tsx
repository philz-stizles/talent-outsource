    ...
    <div className="w-full bg-white">
      ...
      <div className="mt-7 overflow-x-auto">
        <table className="w-full whitespace-nowrap">
          <tbody>
            <tr>
              <th className="focus:outline-none h-16 border border-gray-200 rounded">
                <div className="ml-5">
              ...
              <th className="focus:outline-none h-16 border border-gray-200 rounded">
                <div className="flex items-center pl-5">
                  <p className="text-base leading-none text-gray-700 mr-2">
                    Name
                  </p>
                </div>
              </th>
              ...
              <th className="focus:outline-none h-16 border border-gray-200 rounded"></th>
              <th className="focus:outline-none h-16 border border-gray-200 rounded"></th>
            </tr>
            {data.map((item, i) => (
              <tr
              ...
              >
                ...
                <td className="">
                  <div className="flex items-center pl-5">
                    <p className="text-sm leading-none text-gray-600 ml-2 text-ellipsis">
                      {item.description}
                    </p>
                  </div>
                </td>
                ...
                <td className="pl-5">
                  <button
                    className={classNames(
                      'py-3 px-3 text-sm focus:outline-none leading-none rounded',
                      item.isPublished
